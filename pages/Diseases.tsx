...
const Diseases: React.FC = () => {
  ...
  return (
    <div ref={ref} className="max-w-7xl mx-auto px-4 py-12 animate-fade-in">
      <div className="mb-12">
        <h1 className="animate-slide-up text-3xl sm:text-4xl font-extrabold text-slate-900 mb-4">Répertoire des Maladies</h1>
        ...
        <div className="flex-grow">
          <div className="relative">
            <input
              ...
              className="w-full px-5 py-4 bg-white border border-slate-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all outline-none pl-12 shadow-sm"
              value={searchTerm}
      ...
      <div className="mb-8">
        <span className="text-xs font-bold text-slate-400 uppercase tracking-widest">Résultats : {filteredDiseases.length} maladies</span>
      </div>
      ...
      {filteredDiseases.length > 0 ? (
        ...
        <div className="text-center py-20 bg-white rounded-3xl border border-dashed border-slate-300 animate-scale-in">
          <p className="text-slate-500 mb-4">Aucune maladie ne correspond à votre recherche.</p>
          <button
