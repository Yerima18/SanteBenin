        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="max-w-2xl">
            ...
            <div className="animate-slide-up delay-3 flex flex-wrap gap-4">
              <Link to="/maladies" className="px-6 sm:px-8 py-4 bg-blue-600 text-white font-semibold rounded-xl hover:bg-blue-700 shadow-lg shadow-blue-200 transition-all flex items-center gap-2">
                Catalogue Maladies
              </Link>
              <Link to="/prevention" className="px-6 sm:px-8 py-4 bg-white text-blue-600 border border-blue-200 font-semibold rounded-xl hover:bg-blue-50 transition-all">
                Conseils Prévention
              </Link>
            </div>
          </div>
