'use client';
// This file is a Next.js Client Component (can use hooks like useState)
...
export default function NotFound() {
  ...
  // Popular suggestions to guide the user
  const suggestions = [
      ...
      <div className="max-w-lg w-full">
        ...
        <div className="mb-8">
          ...
          <div className="grid gap-3">
            {/* Show filtered suggestions if searchTerm is typed,
                otherwise show all default suggestions */}
            {(searchTerm ? filteredSuggestions : suggestions).map((item, index) => (
              <Link
                key={index}
                href={item.path}
                className="flex items-center p-3 bg-white border border-gray-200 
        ...
        <Link 
          href="/"
          className="block w-full text-center bg-gradient-to-r from-green-600 to-blue-600 
